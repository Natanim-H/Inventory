...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO transactions (item_id, type, quantity, office_id, notes, created_by) VALUES (?, 'received', ?, ?, ?, ?)");
        ...
        $conn->rollback();
        $error = "Error receiving item: " . $e->getMessage();
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Receive Item - Inventory Management System</title>
    ...
    <div class="container">
        ...
        <div class="form-container">
            <form method="POST" action="">
                ...
                <input type="number" name="quantity" placeholder="Quantity to Receive" required min="1">
